...
public class ClienteRestController {
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		response.put("mensaje", "El Produto eliminado con éxito!");
    ...
    public ResponseEntity<Map<String, Long>> getCantidadClientesPorRegion() {
        Map<String, Long> cantidadPorRegion = clienteService.getCantidadClientesPorRegion();
        return ResponseEntity.ok(cantidadPorRegion);
    }
